...
ARP,地址解析协议是一个通过解析 __网络层地址__, __即IP__ 来找寻 __数据链路层地址__ , __即Mac地址__ 的网络传输协议，它在IPv4中极其重要。    
...
下图A在向B发送数据时，由于子网掩码255.255.255.0告诉它 ，该IP不在同一网络中，因此要通过网关进行转发，此时他的网络层目的地地址为171.43.22.5，但是链路层目的地地址则是网关的链路层地址，即0:18:e7:f3:ce:1a  
